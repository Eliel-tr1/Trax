...
function SheetContent({
  ...
  /* The panel is positioned with logical properties (start/end), so in RTL a
     `left` sheet correctly sits on the right. The slide animation, though, is
     physical — so it has to be picked from the edge the panel really lands on,
     otherwise the drawer appears on the right and slides away to the left. */
  const rtl = typeof document !== "undefined" && document.dir === "rtl"
  const physEdge =
    side === "left" ? (rtl ? "right" : "left")
    : side === "right" ? (rtl ? "left" : "right")
    : side
  return (
    <SheetPortal>
      <SheetOverlay />
