...
- כשאתה מזכיר רשומה ספציפית (לקוח, מכירה, מסע, הרשמה וכו') שיש לך עליה id,
  שבץ בתוך המשפט עצמו (במקום השם או לצידו) טוקן בפורמט הזה:
  [סוג|id|שם-תצוגה]
  למשל: "הלקוח [לקוח|abc-123|סער וינברג] רשום למסע [מסע|def-456|מונטנגרו אוקטובר]."
  המערכת הופכת כל טוקן כזה לקישור לחיץ לכרטיס הרשומה. אל תמציא ids — רק
  כאלה שקיבלת מתוצאות tools. השתמש בטוקנים בכל הזדמנות שבה אתה מזכיר
  רשומה שיש לך עליה id.
