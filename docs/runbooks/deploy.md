...
|---|---|---|
| **Production** | https://app.trax-club.com (live since 2026-09-07, client DNS CNAME verified, HTTPS auto-issued) | deploys to `main` branch of Cloudflare Pages project `trax-crm` |
